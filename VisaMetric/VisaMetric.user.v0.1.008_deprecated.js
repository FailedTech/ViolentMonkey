...
(() => {
    ...
    */
    ...
    let pageState = {
        r200: () => { },
        r403: () => (typeof window._cf_chl_opt !== 'undefined' && 'cZone' in window._cf_chl_opt),
        r405: () => (document.title === 'Not Allowed'),
        r419: () => (true),
        r429: () => { },
        r502: () => ((document.querySelector(".inline-block")?.innerText || '').includes('Bad gateway Error code 502')),
    };
    pageStateChecker = () => { }
