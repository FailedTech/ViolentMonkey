...
(async () => {
    //$.getScript('https://cdnjs.cloudflare.com/ajax/libs/axios/1.5.1/axios.min.js');
    //jQuery.noConflict(true);
    typeof $ === 'undefined' ? await import('https://cdnjs.cloudflare.com/ajax/libs/jquery/3.7.1/jquery.min.js') : null;
    await import('https://cdnjs.cloudflare.com/ajax/libs/axios/1.5.1/axios.min.js');
    ...
    (() => {
        ...
        */
        ...
        let appointmentForm = () => {
            ...
            $("#atm").trigger("click");
            $("#paymentCardInput").val(6362141130399380);
            $("#popupDatepicker2").val("1402/07/03");
            $("#scheba_number").val("IR250620000000301619911003");
            $("#scheba_name").val("Mahshid Jarrahzadeh");
            $("#name1").val("Mahshid");
            $("#surname1").val("Jarrahzadeh");
            $("#birthyear1").val("1995");
            $("#birthmonth1").val("07");
            $("#birthday1").val("22");
            $("#passport1").val("J65193797");
            $("#phone1").val("09129410140");
            $("#email1").val("");
        ...
        let pageState = {
            e200: () => { },
            e403: () => (typeof window._cf_chl_opt !== 'undefined' && 'cZone' in window._cf_chl_opt),
            e405: () => (document.title === 'Not Allowed'),
            e419: () => (true),
            e429: () => { },
            e502: () => ((document.querySelector(".inline-block")?.innerText || '').includes('Bad gateway Error code 502')),
        };
        pageStateChecker = () => { }
